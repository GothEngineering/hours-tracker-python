...
![App Screenshot](hourstrackerimage.png)

(It should look like this on the directory)

![Directory Folder Example](hourstrackerfolder.png)
...
3. Modifiable: Since the data is inside a text file alongside the executable, you can change the hours counter by just changing the decimal number inside the file, and the code will change it into hours and minutes
...
- [ ] An average time with the app open in the past two weeks

- [ ] Changing it to CustomTkinter
